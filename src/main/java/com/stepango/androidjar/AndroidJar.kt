package com.stepango.androidjar
...
class AndroidJar : Plugin<Project> {
    override fun apply(target: Project) {
        target.extensions.create("androidjar", AndroidJarExtension::class.java, target)
    }
}

open class AndroidJarExtension(private val project: Project) {
